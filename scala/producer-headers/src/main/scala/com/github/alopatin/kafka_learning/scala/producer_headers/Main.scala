package com.github.alopatin.kafka_learning.scala.producer_headers

import com.github.alopatin.kafka_learning.scala.producer_headers.model.iot.LocationMeasurement
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    for (_ <- 1 to count) {
      ...
      val record = new ProducerRecord(s"$topic-headers", key, value)

      record.headers().add("model", "TH Sensor 835".getBytes(StandardCharsets.UTF_8))

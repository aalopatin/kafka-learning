package com.github.alopatin.kafka_learning.scala.consumer_protobuf
...
/**
 * Exersice: Write Kafka consumer with Protobuf deserializer
 */
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    kafkaProperties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, classOf[KafkaProtobufDeserializer[LocationMeasurement]].getName)
    ...
    consumer.subscribe(Collections.singletonList(s"$topic-protobuf"))

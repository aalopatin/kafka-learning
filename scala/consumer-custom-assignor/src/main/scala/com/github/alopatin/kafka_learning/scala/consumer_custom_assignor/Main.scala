...
/**
 * Exersice: Write Kafka consumer that uses custom assignor
 */
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    kafkaProperties.put(ConsumerConfig.GROUP_ID_CONFIG, "consumer-custom-assignor")
    ...
    val consumer = new KafkaConsumer[String, Double](kafkaProperties)
